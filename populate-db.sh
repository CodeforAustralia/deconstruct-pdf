...
INSERT INTO letters (uuid, reference_id, template_id, filename, letter_date, created_at, updated_at) VALUES 
('$UUID', '$REF_NO', '$TEMPLATE_NO', '$UUID.html', '$LETTER_DATE', now(), now());
commit;
EOF
